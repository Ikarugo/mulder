...
|-------|----------|-----------:|----------:|----------------:|---------:|-----------:|--------:|--------|-----------|
| [Claude Opus 4.6](https://github.com/calebevans/mulder/tree/main/examples/ndlc-v1.5.2/) (3 runs) | Anthropic | 45% (45 to 50) | 95% (90 to 95) | 10% (5 to 10) | 23 / 24 / 24 | 596 / 500 / 630 | 68 / 69 / 79 min | [run 1](https://calebevans.github.io/mulder/examples/ndlc-v1.5.2/opus-4.6-run1/ndlc.report.html), [run 2](https://calebevans.github.io/mulder/examples/ndlc-v1.5.2/opus-4.6-run2/ndlc.report.html), [run 3](https://calebevans.github.io/mulder/examples/ndlc-v1.5.2/opus-4.6-run3/ndlc.report.html) | [run 1](https://github.com/calebevans/mulder/blob/main/examples/ndlc-v1.5.2/opus-4.6-run1/ACCURACY-REPORT.md), [run 2](https://github.com/calebevans/mulder/blob/main/examples/ndlc-v1.5.2/opus-4.6-run2/ACCURACY-REPORT.md), [run 3](https://github.com/calebevans/mulder/blob/main/examples/ndlc-v1.5.2/opus-4.6-run3/ACCURACY-REPORT.md) |

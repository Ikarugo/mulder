...
|-------|----------|-----------:|----------:|----------------:|---------:|-----------:|--------:|--------|-----------|
| [Claude Opus 4.6](https://github.com/calebevans/mulder/tree/main/examples/ndlc-v1.5.2/opus-4.6-run1/) | Anthropic | 45% | 95% | 10% | 23 | 596 | 68 min | [HTML](https://calebevans.github.io/mulder/examples/ndlc-v1.5.2/opus-4.6-run1/ndlc.report.html) | [ACCURACY-REPORT](https://github.com/calebevans/mulder/blob/main/examples/ndlc-v1.5.2/opus-4.6-run1/ACCURACY-REPORT.md) |

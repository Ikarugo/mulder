...
Published for completeness; neither model produced a full match in three runs,
and both narrate document timestamps as events and read sample-document
metadata as targets. Same file set per directory as above.
...
Tried once each and dropped: Mistral Large 3 (cannot complete the catalog

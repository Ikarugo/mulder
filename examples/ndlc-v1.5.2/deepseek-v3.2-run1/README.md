# NDLC on DeepSeek V3.2, run 1 of 3 (Mulder v1.5.2)
...
**0% full match, 60% detection rate, 25% false positive rate.** One of three DeepSeek runs on this image; see [run 2](../deepseek-v3.2-run2/) (0% / 50% / 20%) and [run 3](../deepseek-v3.2-run3/) (0% / 65% / 20%).
